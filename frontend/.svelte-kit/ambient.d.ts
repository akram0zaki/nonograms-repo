...
declare module '$env/static/private' {
	...
	export const EFC_12008_1592913036: string;
	export const GIT_ASKPASS: string;
	export const GPU_DEVICE_ORDINAL: string;
	...
	export const OCL_ICD_FILENAMES: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		DriverData: string;
		EDITOR: string;
		EFC_12008_1592913036: string;
		GIT_ASKPASS: string;
		GPU_DEVICE_ORDINAL: string;
		HOME: string;
		HOMEDRIVE: string;
		HOMEPATH: string;
		IGCCSVC_DB: string;
